...
module.exports = {
  ...
  chainWebpack: (config) => {
    ...
    // 开发阶段的别名
    config.resolve.alias.set('@mudas/plugin-vue-handler', resolve('packages'));

    // 打包后的测试别名
    // config.resolve.alias.set('@mudas/plugin-vue-handler', resolve('dist/plugin-vue-handler.common.js'));
